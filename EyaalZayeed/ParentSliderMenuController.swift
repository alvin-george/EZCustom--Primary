//
//  ParentSliderMenuController.swift
//  EyaalZayeed
//
...
protocol ParentSlideMenuDelegate {
    func slideMenuItemSelectedAtIndex(_ index : Int32)
}

class ParentSliderMenuController: UIViewController, UITableViewDataSource,UITableViewDelegate, UIScrollViewDelegate{
    
    var appUIColor_First:UIColor = UIColor(rgb: 0x3F51B5)
    var btnMenu : UIButton!
    var delegate : ParentSlideMenuDelegate?
    ...
    {
        addStatusBar()
        sideMenuButton.addTarget(self, action: #selector(ParentSliderMenuController.onCloseMenuClick(_:)), for: UIControlEvents.touchUpInside)
