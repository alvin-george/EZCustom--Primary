//
//  TeacherSliderMenuController.swift
//  EyaalZayeed
//
...
protocol TeacherSlideMenuDelegate {
    func slideMenuItemSelectedAtIndex(_ index : Int32)
}

class TeacherSliderMenuController: UIViewController, UITableViewDataSource,UITableViewDelegate, UIScrollViewDelegate{
    
    var appUIColor_First:UIColor = UIColor(rgb: 0x3F51B5)
    
    var btnMenu : UIButton!
    var delegate : TeacherSlideMenuDelegate?
    ...
    {
        addStatusBar()
        sideMenuButton.addTarget(self, action: #selector(TeacherSliderMenuController.onCloseMenuClick(_:)), for: UIControlEvents.touchUpInside)
