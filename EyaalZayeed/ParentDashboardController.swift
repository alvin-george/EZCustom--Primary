//
//  ParentDashboardController.swift
//  EyaalZayeed
//
...
class ParentDashboardController: UIAppViewController ,ParentSlideMenuDelegate, CircleMenuDelegate {
    ...
    @IBOutlet weak var ParentNameLabel: EZLabel!
    ...
    func initialUISetup()
    {
        ...
        sideMenuButton.addTarget(self, action: #selector(ParentDashboardController.onSlideMenuButtonPressed(_:)), for: UIControlEvents.touchUpInside)
    ...
    func onSlideMenuButtonPressed(_ sender : UIButton){
        ...
        let menuVC : ParentSliderMenuController = UIStoryboard(name: STORYBOARD_TYPE.PARENT_MODULE.rawValue, bundle: nil).instantiateViewController(withIdentifier: "parentSliderMenuController") as! ParentSliderMenuController
    ...
    func circleMenu(_ circleMenu: CircleMenu, buttonWillSelected button: UIButton, atIndex: Int) {
        ...
        DispatchQueue.main.asyncAfter(deadline: (DispatchTime.now() + DispatchTimeInterval.seconds(Int(1)))){
            ...
            switch atIndex {
            case 0:
                self.performSegue(withIdentifier: "segueToParentProfileController", sender: self)
            case 1:
                self.performSegue(withIdentifier: "segueToParentContactController", sender: self)
            case 2:
                self.performSegue(withIdentifier: "segueToParentSubjectController", sender: self)
            case 3:
                self.performSegue(withIdentifier: "segueToParentReportController", sender: self)
            case 4:
                self.performSegue(withIdentifier: "segueToParentNotificationsController", sender: self)
            case 5:
                self.performSegue(withIdentifier: "segueToParentActivityController", sender: self)
            case 6:
                self.performSegue(withIdentifier: "segueToParentChildController", sender: self)
            default:
                break;
            }
        }
